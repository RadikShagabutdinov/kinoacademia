...
Изменение `randomizer` — часть постоянного рейтинга персонажа, поэтому оно сразу переносится в `company_ratings.employee_permanent` работодателя (как и любое другое изменение постоянного рейтинга, см. «Постоянный рейтинг компании»). Обнуление рандомайзера точно так же откатывает перенесённую величину.
