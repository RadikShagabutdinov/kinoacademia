  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-40 px-4 pb-[max(1rem,env(safe-area-inset-bottom))] md:hidden">
      <nav
        ...
        className="mx-auto flex max-w-md items-center justify-between gap-1 rounded-[var(--radius-pill)] border border-[var(--color-border)] bg-[color-mix(in_oklab,var(--color-elevated)_92%,transparent)] px-2.5 py-2 backdrop-blur-xl"
      >
